...
const FEATURES = [
  {
    icon: "📥",
    title: "Auto-detected invites",
    desc: "Connects to Google Calendar and automatically pulls every meeting invite — no manual entry, no missed events.",
  },
  {
    icon: "🗂️",
    title: "Unified timeline",
    desc: "Today, this week, upcoming — all in one dashboard. Filter by date, platform, or organiser in seconds.",
  },
  {
    icon: "🔒",
    title: "Read-only & private",
    desc: "XEOBIT only reads your Google Calendar. It never modifies, stores, or shares your email data with anyone.",
  },
  {
    icon: "⚡",
    title: "Instant overview",
    desc: "Open the app and know your full day in under five seconds. No digging through threads.",
  },
  {
    icon: "🖥️",
    title: "Desktop-native",
    desc: "A lightweight desktop app — always accessible, no tab hunting, no browser fatigue.",
  },
  {
    icon: "🔗",
    title: "Any platform",
    desc: "Google Meet, Teams, Webex — XEOBIT detects meeting links across all platforms automatically.",
  },
];
...
const STEPS = [
  {
    ...
    desc: "Sign in with Google — a one-time OAuth flow. XEOBIT only requests read-only access to your calendar.",
  },
  {
    num: "2",
    title: "XEOBIT scans your calendar",
    desc: "The app automatically identifies and organises all meeting invites, extracting times, links, and attendees.",
  },
  {
    num: "3",
    title: "See your day clearly",
    desc: "Your unified meeting dashboard is ready. Always up to date with your latest invites.",
  },
];
        ...
        <div className={styles.heroInner}>
          ...
          <div className={styles.heroContent}>
            ...
            <h2>
              ...
              <br />
              <em>
                The Intelligence Layer for Modern Hybrid Learning Environments
              </em>
            </h2>
            <p className={styles.heroSub}>
              Transform lectures into structured learning experiences with
              AI-powered content generation, assessment, and analytics
            </p>
        ...
        <Section>
          ...
          {submitted ? (
            <div className={styles.successMsg}>
              ✓ You're download will start soon. Our team will soon provide you
