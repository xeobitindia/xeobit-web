          ...
          <div className={styles.heroInner}>
            ...
            <Fade delay={0.1}>
              <h1>
                Your meetings,
                <br />
                <em>always in sight.</em>
              </h1>
            </Fade>
            <Fade delay={0.2}>
              <p className={styles.heroSub}>
                A focused desktop app that connects to your Gmail account and
                displays all your meeting invites in one clean dashboard. No
                noise, no fluff — just what matters next.
              </p>
            </Fade>
            <Fade delay={0.3}>
          ...
          <div className={styles.signInGrid}>
            <Fade delay={0.05}>
              <div className={styles.signInText}>
                ...
                <p>
                  Sign in with your Google account and XEOBIT immediately begins
                  scanning your Calendar for meeting invites. The whole process
                ...
                <ul className={styles.signInPoints}>
                  <li>
                    ...
                    <span>
                      Read-only Google Calendar access — we can never modify
                      your inbox
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    <span className={styles.tick}>✓</span>
                    <span>
                      Disconnect anytime from your Google account settings
                    </span>
                  </li>
                </ul>
              </div>
                ...
                {[
                  {
                    ...
                    status: "live",
                    items: [
                      "Gmail meeting detection",
                      "Zoom · Meet · Teams links",
